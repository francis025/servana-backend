            ...
            <div class="container-fluid card p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg" id="translationDiv-<?= $language['code'] ?>" <?= $language['code'] == $current_language ? 'style="display: block;"' : 'style="display: none;"' ?>>
                        <textarea rows=50 class='form-control h-50 summernotes' name="customer_terms_conditions[<?= $language['code'] ?>]"><?= isset($customer_terms_conditions[$language['code']]) ? $customer_terms_conditions[$language['code']] : '' ?></textarea>
                    </div>
                    <?php } ?>
                </div>
                <div class="row mt-2">
