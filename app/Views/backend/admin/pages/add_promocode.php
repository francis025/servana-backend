                ...
                <div class="col-md-12">
                    <div class="card">
                        <form method="post" action="<?= base_url('admin/promo_codes/save') ?>" id="promo_code_form" class="form-submit-event">
                            <div class="row m-0 pl-3 border_bottom_for_cards">
                                <div class="col-auto">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="categories" id="categories">
                                            ...
                                            <!-- Provider must be chosen so promo code ownership stays consistent -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="minimum_order_amount" name="minimum_order_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_of_users" name="no_of_users" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="discount" name="discount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="max_discount_amount" name="max_discount_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        ?>
                                            <div class="form-group" id="translationDiv-<?= $language['code'] ?>" <?= $language['code'] == $current_language ? 'style="display: block;"' : 'style="display: none;"' ?>>
                                                ...
                                                <textarea id="message<?= $language['code'] ?>" class="form-control h-25 border" name="message[<?= $language['code'] ?>]"></textarea>
                                            </div>
                                        <?php } ?>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="old_image " class="required"><?= labels('image', 'Image') ?></label> <small>(<?= labels('promocode_image_recommended_size', 'We recommend 50 x 50 pixels') ?>)</small>
...
<script>
    // Language switching functionality for multi-language message fields
    $(document).ready(function() {
        ...
        $(document).on('click', '.language-option', function() {
            ...
            // Show/hide appropriate message textarea
