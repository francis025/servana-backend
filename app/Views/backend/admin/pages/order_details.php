                                    ...
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                        <div class="card text-dark border-bottom" style="border: none!important;">
                                            ...
                                            <div class="row m-0 work_started_proof">
                                                <div class="col-md">
                                                    <div class="form-group">
                                                        <label><?= labels('work_started_proof', "Work Started Proof") ?></label> <small>(<?= labels('other_image_recommended_size', 'We recommend 960 x 540 pixels') ?>)</small>
                                            ...
                                            <div class="row m-0 work_completed_proof">
                                                <div class="col-md">
                                                    <div class="form-group">
                                                        <label><?= labels('work_completed_proof', "Work Completed Proof") ?></label> <small>(<?= labels('other_image_recommended_size', 'We recommend 960 x 540 pixels') ?>)</small>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <label for="" class="bold"> <?= !empty($order_details['translated_company_name']) ? $order_details['translated_company_name'] : labels('no_data_found', 'No Data Found') ?> </label>
                                                    </li>
                                                    <li class="nav-item">
                                        ...
                                        if ((in_array($ext, $video_exytension))) { ?>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                                <div class="proof-aspect-ratio bg-light rounded shadow-sm">
                                                    <button type="button" class="btn btn-primary position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center border-0 rounded myBtn" data-analystId="<?= $row ?>">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                                <div class="proof-aspect-ratio bg-light rounded shadow-sm overflow-hidden">
                                                    <a href="<?php echo $row ?>" data-lightbox="work-started-proof" class="d-block w-100 h-100">
                                                        <img src="<?php echo $row ?>" alt="Work Started Proof" class="w-100 h-100 proof-img">
                                                    </a>
                                                </div>
                                            </div>
                                        <?php    } ?>
                                ...
                                <div class="row m-3">
                                    ...
                                    foreach ($order_details['work_completed_proof'] as $row) {
                                        ...
                                        if ((in_array($ext, $video_exytension))) { ?>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                                <div class="proof-aspect-ratio bg-light rounded shadow-sm">
                                                    <button type="button" class="btn btn-primary position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center border-0 rounded myBtn_completed" data-analystId="<?= $row ?>">
                                                        <span class="material-symbols-outlined mr-2">play_circle</span>
                                                        <?= labels('open_video', 'Open Video') ?>
                                                    </button>
                                                </div>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                                <div class="proof-aspect-ratio bg-light rounded shadow-sm overflow-hidden">
                                                    <a href="<?php echo $row ?>" data-lightbox="work-completed-proof" class="d-block w-100 h-100">
                                                        <img src="<?php echo $row ?>" alt="Work Completed Proof" class="w-100 h-100 proof-img">
                                                    </a>
                                                </div>
                                            </div>
                                        <?php    } ?>
...
<style>
    /* Minimal CSS - maintains 16:9 aspect ratio using Bootstrap-compatible approach */
    .proof-aspect-ratio {
        position: relative;
        width: 100%;
        padding-bottom: 56.25%;
        /* 16:9 aspect ratio (960x540 recommended) */
    }
    ...
    /* Image styling using Bootstrap utilities + minimal custom CSS */
    .proof-img {
        object-fit: cover;
