                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderd" data-pagination-successively-size="2" id="cash_collection"
                                ...
                                <thead>
                                    <tr>
                                        <th data-field="partner_name" class="text-center" data-visible="true"><?= labels('partner_name', 'Provider')  ?></th>
                                        <th data-field="message" class="text-center" data-visible="true"><?= labels('message', 'message')  ?></th>
                                        <th data-field="commison" class="text-center" data-visible="true"><?= labels('amount', 'amount')  ?></th>
